...
var sayHello = function sayHello() {
  var your_name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "ゲスト";
  return console.log("\u3053\u3093\u306B\u3061\u306F".concat(your_name, "\u3055\u3093\u3002"));
}; //your_name = ゲスト←ここがデフォルト値
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "36737" + '/');
